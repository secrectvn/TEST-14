...
class report_account_general_ledger_bi(models.AbstractModel):
    ...
    _description = "Libro Mayor(Avanzado)"
    ...
    def _get_columns_name(self, options):
        return [
            ...
            {'name': _("Cliente")},
            {'name': _("Movimiento")},
            {'name': _("Saldo Anterior"), 'class': 'number'},
            {'name': _("Cargos"), 'class': 'number'},
            {'name': _("Abonos"), 'class': 'number'},
            {'name': _("Saldo Actual"), 'class': 'number'}]

    @api.model
    def _get_report_name(self):
        return _("Libro Mayor")
    ...
    def _do_query(self, options, line_id, group_by_account=True, limit=False):
        ...
        if options.get('custom_account_ids') or options.get('custom_account_type_ids'):
